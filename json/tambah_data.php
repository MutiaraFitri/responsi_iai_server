...
<body>
    <nav class="white" role="navigation">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                <li><a href="./">JSON</a></li>
                <li><a href="#" onclick="M.toast({html: 'Coming Soon'})">XML</a></li>
  ...
  <div id="index-banner" class="parallax-container" style="height:220vh;">
        ...
        <div class="card">
            <div class="card-content white-text">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                        <input id="daerah" type="text" class="validate" name="daerah" required>
