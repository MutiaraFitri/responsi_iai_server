        ...
        <div class="nav-wrapper container">
          <a href="." class="brand-logo mahdojan-font">Mahdo<span style="color:red">j</span>an</a>
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <li><a class="waves-effect waves-light btn" href="/json/tambah_data.php"><i class="material-icons right">add</i>Tambah Data</a></li>
            </ul>
        </div>
    </nav>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <a href="read_all.php" id="download-button" class="btn-large waves-effect waves-light teal lighten-1">Get All</a>
        </div>
        <br><br>
